...
public class ViaEventMakePublicCommand
{
    ...
    public static OperationResult<ViaEventMakePublicCommand> Create(string id)
    {
        ...
        return eventId.IsFailure ? OperationResult<ViaEventMakePublicCommand>.Failure(eventId.OperationErrors) : OperationResult<ViaEventMakePublicCommand>.Success(new ViaEventMakePublicCommand(eventId.Payload));
    }
