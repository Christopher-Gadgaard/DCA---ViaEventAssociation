...
public class ViaEventCreateCommand
{
    ...
    public static OperationResult<ViaEventCreateCommand> Create()
    {
        ...
        return eventId.IsFailure ? OperationResult<ViaEventCreateCommand>.Failure(eventId.OperationErrors) : OperationResult<ViaEventCreateCommand>.Success(new ViaEventCreateCommand(eventId.Payload));
    }
