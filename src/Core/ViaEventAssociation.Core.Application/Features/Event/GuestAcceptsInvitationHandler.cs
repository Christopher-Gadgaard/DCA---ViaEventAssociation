...
internal class GuestAcceptsInvitationHandler : ICommandHandler<GuestAcceptsInvitationCommand>
{
    ...
    internal GuestAcceptsInvitationHandler(IViaEventRepository eventRepository, IViaGuestRepository guestRepository,
    ...
    public async Task<OperationResult> Handle(GuestAcceptsInvitationCommand command)
    {
        ...
        OperationResult result = viaEvent.AcceptInvitation(command.InvitationId);
